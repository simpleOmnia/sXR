...
// Copied form sample scene in Unity XR Interaction
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ActionBasedControllerManager_COPY : MonoBehaviour
    {
        /// <summary>
        /// Order when instances of type <see cref="ActionBasedControllerManager_COPY"/> are updated.
        /// </summary>
        /// <remarks>
